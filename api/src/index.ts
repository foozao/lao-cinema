...
await fastify.register(csrfRoutes, { prefix: '/api' });
...
await fastify.register(personAccoladesRoutes, { prefix: '/api' });
...
await fastify.register(trailerTokenRoutes, { prefix: '/api' });
...
await fastify.register(pricingRoutes, { prefix: '/api' });
