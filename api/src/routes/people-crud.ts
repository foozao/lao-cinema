 ...
 * People CRUD Routes
 * 
 * Basic CRUD operations for people: list/search, get by ID, create, update, delete
 */
...
import { buildPersonLocalizedTexts } from '../lib/translation-helpers.js';

export default async function peopleCrudRoutes(fastify: FastifyInstance) {
