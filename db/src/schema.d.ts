...
export declare const movies: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        availabilityStatus: import("drizzle-orm/pg-core").PgColumn<{
            ...
            dataType: "string";
            columnType: "PgEnumColumn";
            data: "auto" | "external" | "available" | "unavailable" | "coming_soon";
            driverParam: string;
            notNull: false;
            hasDefault: true;
            isPrimaryKey: false;
...
export declare const personImages: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "person_images";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "person_images";
            dataType: "string";
            columnType: "PgUUID";
            data: string;
            driverParam: string;
...
export declare const homepageSettings: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        randomizeFeatured: import("drizzle-orm/pg-core").PgColumn<{
...
export declare const movieExternalPlatforms: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        platform: import("drizzle-orm/pg-core").PgColumn<{
            ...
            dataType: "string";
            columnType: "PgEnumColumn";
            data: "other" | "netflix" | "prime" | "disney" | "hbo" | "apple" | "hulu";
            driverParam: string;
            notNull: true;
            hasDefault: false;
            isPrimaryKey: false;
...
export declare const rentals: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        currentShortId: import("drizzle-orm/pg-core").PgColumn<{
            name: "current_short_id";
            tableName: "rentals";
            dataType: "string";
            columnType: "PgUUID";
            data: string;
...
export declare const auditLogs: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        action: import("drizzle-orm/pg-core").PgColumn<{
            ...
            dataType: "string";
            columnType: "PgEnumColumn";
            data: "update" | "delete" | "create" | "add_cast" | "remove_cast" | "update_cast" | "add_crew" | "remove_crew" | "update_crew" | "add_image" | "remove_image" | "set_primary_image" | "add_video" | "remove_video" | "update_video" | "add_genre" | "remove_genre" | "add_production_company" | "remove_production_company" | "add_platform" | "remove_platform" | "update_platform" | "feature_movie" | "unfeature_movie" | "merge_people" | "update_person";
            driverParam: string;
            notNull: true;
            hasDefault: false;
            isPrimaryKey: false;
...
export declare const awardNomineeTypeEnum: import("drizzle-orm/pg-core").PgEnum<["person", "movie"]>;
export declare const awardShows: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "award_shows";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "award_shows";
            dataType: "string";
            columnType: "PgUUID";
            data: string;
            driverParam: string;
...
export declare const awardShowTranslations: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "award_show_translations";
    schema: undefined;
    columns: {
        showId: import("drizzle-orm/pg-core").PgColumn<{
            name: "show_id";
            tableName: "award_show_translations";
            dataType: "string";
            columnType: "PgUUID";
            data: string;
            driverParam: string;
...
export declare const awardEditions: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "award_editions";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "award_editions";
            dataType: "string";
            columnType: "PgUUID";
            data: string;
            driverParam: string;
        ...
        editionNumber: import("drizzle-orm/pg-core").PgColumn<{
            name: "edition_number";
            tableName: "award_editions";
            dataType: "number";
            columnType: "PgInteger";
...
export declare const awardEditionTranslations: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "award_edition_translations";
    schema: undefined;
    columns: {
        editionId: import("drizzle-orm/pg-core").PgColumn<{
            name: "edition_id";
            tableName: "award_edition_translations";
            dataType: "string";
            columnType: "PgUUID";
            data: string;
            driverParam: string;
...
export declare const awardCategories: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "award_categories";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "award_categories";
            dataType: "string";
            columnType: "PgUUID";
            data: string;
            driverParam: string;
...
export declare const awardCategoryTranslations: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "award_category_translations";
    schema: undefined;
    columns: {
        categoryId: import("drizzle-orm/pg-core").PgColumn<{
            name: "category_id";
            tableName: "award_category_translations";
            dataType: "string";
            columnType: "PgUUID";
            data: string;
            driverParam: string;
...
export declare const awardNominations: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "award_nominations";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "award_nominations";
            dataType: "string";
            columnType: "PgUUID";
            data: string;
            driverParam: string;
        ...
        forMovieId: import("drizzle-orm/pg-core").PgColumn<{
            name: "for_movie_id";
            tableName: "award_nominations";
            dataType: "string";
            columnType: "PgUUID";
...
export declare const awardNominationTranslations: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "award_nomination_translations";
    schema: undefined;
    columns: {
        nominationId: import("drizzle-orm/pg-core").PgColumn<{
            name: "nomination_id";
            tableName: "award_nomination_translations";
            dataType: "string";
            columnType: "PgUUID";
            data: string;
            driverParam: string;
        ...
        workTitle: import("drizzle-orm/pg-core").PgColumn<{
            name: "work_title";
            tableName: "award_nomination_translations";
            dataType: "string";
            columnType: "PgText";
